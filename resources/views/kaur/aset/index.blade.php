                        ...
                        @foreach ($aset as $a)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span
                                        class="badge @if ($a->status == 'Pending') bg-label-warning @elseif($a->status == 'Aktif') bg-label-success @else bg-label-danger @endif">{{ $a->status }}</span>
                                </td>
                                <td>
                                    <a href="{{ route('aset.view', $a->kd_aset) }}" type="button"
                                    ...
                                    <a type="button" href="{{ route('aset.destroy', $a->kd_aset) }}"
                            ...
                            <div class="modal fade" id="deleteModal{{ $a->kd_aset }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('aset.destroy', $a->kd_aset) }}" method="POST"
