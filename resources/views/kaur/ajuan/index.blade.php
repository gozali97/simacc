                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        @foreach ($data as $d)
                            <tr>
                                ...
                                <td>
                                    @if ($d->status == 'Proses')
                                        <a href="{{ route('kaurajuan.edit', $d->kd_kebutuhan) }}" type="button"
                                ...
                                Selesai
                                        ...
                                        <button data-bs-toggle="modal" data-bs-target="#exLargeModal{{ $d->kd_kebutuhan }}"
                            ...
                            <div class="modal fade" id="deleteModal{{ $d->kd_kebutuhan }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('kaurajuan.destroy', $d->kd_kebutuhan) }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">Apakah Anda yakin ingin hapus <span
                                                    class="fw-bold">{{ $d->nama_kebutuhan }}</span>?</div>
