            ...
            <form action="{{ route('kaurs.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control" value="{{ $data->nama }}" placeholder="Nama Lengkap" />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="no_hp" class="form-control" value="{{ $data->no_hp }}" placeholder="08xxxxx" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Alamat</label>
                        <input type="text" name="alamat" class="form-control" value="{{ $data->alamat }}" placeholder="Jl. xxx" />
                    </div>
                    <div class="mb-4">
                        <div class="row">
                          <div class="col-md-6">
