                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span
                                class="badge @if($d->status == 'Aktif') bg-label-success @else bg-label-primary @endif">{{
                                $d->status }}</span>
                        </td>
                        <td>
                            <div class="btn-group" role="group" aria-label="First group">
                                ...
                                @if ($d->status == 'Proses')
                                <button data-bs-toggle="modal" data-bs-target="#confirmModal{{ $d->kd_perencanaan }}"
                                    class="btn btn-icon btn-success">
                                    <i class="bx bx-check-square bx-tada-hover"></i>
                                </button>
                                <button data-bs-toggle="modal" data-bs-target="#declineModal{{ $d->kd_perencanaan }}"
                        ...
                        <div class="modal-dialog modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel4">Detail Perencanaan</h5>
