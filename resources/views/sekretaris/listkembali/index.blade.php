                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        @foreach ($data as $a)
                            ...
                            <div class="modal fade" id="confirmModal{{ $a->kd_kembali }}"
                                aria-labelledby="modalToggleLabel{{ $a->kd_kembali }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('listkembali.confirm', $a->kd_kembali) }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">Apakah Anda yakin ingin konfirmasi pengembalian <span
                            ...
                            <div class="modal fade" id="declineModal{{ $a->kd_kembali }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('listkembali.decline', $a->kd_kembali) }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">Apakah Anda yakin ingin tolak pengembalian <span
                                                    class="fw-bold">{{ $a->nama_aset }}</span>?</div>
                                            <input type="hidden" name="id_pinjam" value="{{ $a->kd_kembali }}">
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-outline-secondary"
