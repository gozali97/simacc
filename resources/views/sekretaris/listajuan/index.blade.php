                        ...
                        @foreach ($data as $d)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span
                                        class="badge @if ($d->status == 'Proses') bg-label-warning @elseif($d->status == 'Disetujui') bg-label-success @else bg-label-danger @endif">{{ $d->status }}</span>
                                </td>
                                <td>
                                    <div class="btn-group" role="group" aria-label="First group">
                                        <button type="button" data-bs-toggle="modal"
                                            data-bs-target="#exLargeModal{{ $d->kd_kebutuhan }}"
                                            class="btn btn-icon btn-info">
                                            <span class="tf-icons bx bx-info-circle bx-tada-hover"></span>
                                        </button>
                                        @if ($d->status == 'Proses')
                                            <button data-bs-toggle="modal"
                                                data-bs-target="#confirmModal{{ $d->kd_kebutuhan }}"
                                                class="btn btn-icon btn-success">
                                                <i class="bx bx-check-square bx-tada-hover"></i>
                                            </button>
                                            <button data-bs-toggle="modal"
                                                data-bs-target="#declineModal{{ $d->kd_kebutuhan }}"
                                                class="btn btn-icon btn-danger">
                                                <i class="bx bx-x-circle bx-tada-hover"></i>
                                            </button>
                                        @elseif($d->status == 'Disetujui')
                                            <button data-bs-toggle="modal"
                                                data-bs-target="#cancelModal{{ $d->kd_kebutuhan }}"
                            ...
                            <!-- Modal Info -->
                            <div class="modal fade" id="exLargeModal{{ $d->kd_kebutuhan }}" tabindex="-1"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="nama"
                                                            ...
                                                            placeholder="Nama kebutuhan" value="{{ $d->nama_kebutuhan }}"
                                                            readonly />
                                                        @error('nama')
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="jumlah"
                                                            ...
                                                            type="number" id="html5-date-input"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" name="tanggal"
                                                            ...
                                                            placeholder="" value="{{ $d->tgl_kebutuhan }}" readonly />
                                                        @error('tanggal')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <img class="mt-4" id="preview"
                                                                src="{{ url('/assets/img/', $d->gambar) }}"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="modal fade" id="confirmModal{{ $d->kd_kebutuhan }}"
                                aria-labelledby="modalToggleLabel{{ $d->kd_kebutuhan }}" tabindex="-1"
                                style="display: none;" aria-hidden="true">
                            ...
                            <!-- Modal Konfirmasi -->
                            <div class="modal fade" id="cancelModal{{ $d->kd_kebutuhan }}"
                                aria-labelledby="modalToggleLabel{{ $d->kd_kebutuhan }}" tabindex="-1"
                                style="display: none;" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('listajuan.cancel', $d->kd_kebutuhan) }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">Apakah Anda yakin ingin membatalkan persetujuan
                                                kebutuhan <span class="fw-bold">{{ $d->nama_aset }}</span>?</div>
                                            <input type="hidden" name="id_pinjam" value="{{ $d->kd_kebutuhan }}">
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-outline-secondary"
                                                    data-bs-dismiss="modal">
