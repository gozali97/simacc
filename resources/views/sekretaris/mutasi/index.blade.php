                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="First group">
                                <a href="{{ route('listmutasi.view',$a->kd_mutasi) }}" type="button" class="btn btn-icon btn-info detail-pinjam-btn" data-kd="{{ $a->kd_mutasi }}">
                                ...
                                <button data-bs-toggle="modal" data-bs-target="#declineModal{{ $a->kd_mutasi }}"
                    ...
                    <div class="modal fade" id="confirmModal{{ $a->kd_mutasi }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('listmutasi.confirm',$a->kd_mutasi) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                    ...
                    <div class="modal fade" id="declineModal{{ $a->kd_mutasi }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('listmutasi.decline',$a->kd_mutasi) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
