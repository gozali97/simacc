...
>
  <head>
    ...
    <title>Login | Sistem Informasi Manajemen Aset Desa Cibentang</title>
              ...
              <div class="app-brand justify-content-center">
                <a href="#" class="app-brand-link gap-2">
                 <img src="{{ url('assets/img/logo.png') }}" style="width: 40px" alt="">
                  <h4 class="text-lg mt-3 text-primary" style="font-weight: bold;">SIMAC</h4>
                </a>
              </div>
              <!-- /Logo -->
              {{-- <h4 class="mb-2">Welcome to SIMACC! 👋</h4> --}}
