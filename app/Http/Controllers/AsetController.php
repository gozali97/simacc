...
class AsetController extends Controller
{
    public function index()
    {
        ...
        return view('sekretaris.aset.index', compact('aset'));
    }
    ...
    public function create()
    {
        ...
        return view('sekretaris.aset.create', compact('jenis', 'ruang'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('sekretaris.aset.edit', compact('data', 'jenis', 'ruang'));
    }
